...
const ScheduleTemplate = () => {
  ...
  const [template, setTemplate] = useState(
    JSON.parse(localStorage.getItem("templateDetails"))
  );
  const [subject, setSubject] = useState(template.TemplateName);
  ...
  const [participants, setParticipants] = useState(template.Parties);
